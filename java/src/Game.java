...
public class Game {
    ...
    private char lastPlayedSymbol = Players.getNoPlayer();
    ...
    private void validatePlayerNotOverrideAlreadyPlayedTitle(int x, int y) throws InvalidPosition {
        if (board.TileAt(x, y).Symbol != Players.getNoPlayer()) {
    ...
    private boolean isFirstMove() {
        return lastPlayedSymbol == Players.getNoPlayer();
    }

    public char Winner() {
        //if the positions in first row are taken
        if (board.TileAt(0, 0).Symbol != Players.getNoPlayer() && board.TileAt(0, 1).Symbol != Players.getNoPlayer() && board.TileAt(0, 2).Symbol != Players.getNoPlayer()) {
        ...
        //if the positions in first row are taken
        if (board.TileAt(1, 0).Symbol != Players.getNoPlayer() && board.TileAt(1, 1).Symbol != Players.getNoPlayer() && board.TileAt(1, 2).Symbol != Players.getNoPlayer()) {
        ...
        //if the positions in first row are taken
        if (board.TileAt(2, 0).Symbol != Players.getNoPlayer() && board.TileAt(2, 1).Symbol != Players.getNoPlayer() && board.TileAt(2, 2).Symbol != Players.getNoPlayer()) {
            //if middle row is full with same symbol
